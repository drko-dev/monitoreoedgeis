...
type Snapshot struct {
	...
	// (frames encoded/uploaded, bytes, latency). Omitted when the cloud sink
	// is disabled/unconfigured. This is telemetry only — never a priced or
	// estimated cost (see internal/cloudsink).
