...
func TestHeartbeatErrorClassification(t *testing.T) {
	tests := map[string]struct {
		...
		"408 -> retryable":    {http.StatusRequestTimeout, ErrRetryableStatus, nil},
		"500 -> retryable":    {http.StatusInternalServerError, ErrRetryableStatus, nil},
		"503 -> retryable":    {http.StatusServiceUnavailable, ErrRetryableStatus, nil},
		"599 -> retryable":    {599, ErrRetryableStatus, nil},
		"600 -> unexpected":   {600, ErrUnexpectedStatus, nil},
		"700 -> unexpected":   {700, ErrUnexpectedStatus, nil},
